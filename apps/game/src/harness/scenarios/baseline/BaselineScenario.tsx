...
export function BaselineScenario() {
  ...
  const activeDialog = story.backlog.at(-1) ?? {
    ...
    text:
      mode === "navi"
        ? "Navi owns walk, interactions, inventory, and VN2D overlays."
        : "Trial owns discussion, VN3D staging, debate, evidence, and branch outcomes."
  };
  ...
  return (
    <main className="app-shell">
      <span className="visually-hidden" data-testid="harness-scenario-id">
        baseline
      </span>
