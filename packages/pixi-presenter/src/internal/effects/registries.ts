...
export const PERSISTENT_SCREEN_EFFECT_KEYS = ["bokeh", "glitch"] as const;
export const TRANSIENT_EFFECT_HINT_TYPES = ["flash", "shake", "glitch"] as const satisfies readonly PixiStageRenderHint["type"][];
